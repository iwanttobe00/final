# Generated by Django 2.2.16 on 2022-07-29 15:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Администратор'), ('moderator', 'Модератор'), ('user', 'Аутентифицированный пользователь')], default='user', max_length=10, verbose_name='Роль')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.SmallIntegerField(validators=[django.core.validators.MinValueValidator(1, 'Допустимы значения 1 и более'), django.core.validators.MaxValueValidator(10, 'Допустимы значения 10 и менее')], verbose_name='Рейтинг')),
